...
const potionItems = [
    {
        id: 'potion_xp_50',
        name: 'Gota de Sabedoria',
        description: 'Concede 50 XP. Perfeito para um pequeno empurrão.',
        price: 5,
        currency: 'gems',
        imageUrl: 'https://images.unsplash.com/photo-1555118228-6951335a8f33?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxibHVlJTIwcG90aW9ufGVufDB8fHx8MTc1OTYwMTY2MXww&ixlib=rb-4.1.0&q=80&w=1080',
        aiHint: 'blue potion',
        icon: Droplets,
        reward: { type: 'item', id: 'potion_xp_50', name: 'Gota de Sabedoria', quantity: 1 },
    },
    {
        id: 'potion_coin_100',
        name: 'Essência de Sorte',
        description: 'Concede 100 moedas para pequenas compras.',
        price: 5,
        currency: 'gems',
        imageUrl: 'https://images.unsplash.com/photo-1555118228-6951335a8f33?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxncmVlbiUyMHBvdGlvbnxlbnwwfHx8fDE3NTk2MDE2NjF8MA&ixlib=rb-4.1.0&q=80&w=1080',
        aiHint: 'green potion',
        icon: TestTube2,
        reward: { type: 'item', id: 'potion_coin_100', name: 'Essência de Sorte', quantity: 1 },
    },
    {
        id: 'potion_xp_200',
    ...
    },
    {
        ...
        price: 100,
        currency: 'gems',
        imageUrl: 'https://images.unsplash.com/photo-1555118228-6951335a8f33?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxicm93biUyMHBvdGlvbnxlbnwwfHx8fDE3NTk2MDE2NjF8MA&ixlib=rb-4.1.0&q=80&w=1080',
        aiHint: 'brown potion',
        icon: Atom,
    ...
    },
    {
        ...
        price: 8,
        currency: 'gems',
        imageUrl: 'https://images.unsplash.com/photo-1555118228-6951335a8f33?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxncmF5JTIwcG90aW9ufGVufDB8fHx8MTc1OTYwMTY2MXww&ixlib=rb-4.1.0&q=80&w=1080',
        aiHint: 'gray potion',
        icon: TestTube2,
