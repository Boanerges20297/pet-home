      ...
      <div className="mx-auto max-w-lg w-full">
        ...
        <Card className="text-center">
          <CardHeader>
            ...
            <CardTitle className="font-headline text-3xl md:text-4xl text-primary mt-4">Quebra-Cabeça de Pata</CardTitle>
          ...
          <CardContent>
            <p className="text-muted-foreground">
                Nossos melhores desenvolvedores de filhotes estão trabalhando duro para trazer esta aventura até você. Volte em breve para resolver quebra-cabeças divertidos com imagens dos seus filhotes!
            </p>
          </CardContent>
        </Card>
      </div>
