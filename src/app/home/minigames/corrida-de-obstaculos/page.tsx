      ...
      <div className="mx-auto max-w-lg w-full">
        ...
        <Card className="text-center">
          <CardHeader>
            ...
            <CardTitle className="font-headline text-3xl md:text-4xl text-primary mt-4">Corrida de Obstáculos</CardTitle>
          ...
          <CardContent>
            <p className="text-muted-foreground">
                Nossos melhores desenvolvedores de filhotes estão trabalhando duro para trazer esta aventura até você. Volte em breve para guiar seu pet por uma pista cheia de desafios!
            </p>
          </CardContent>
        </Card>
      </div>
